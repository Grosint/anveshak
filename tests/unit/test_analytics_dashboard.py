...
class TestGetDashboardData:
    ...
    async def test_sentiment_distribution_is_dict(self, mock_conn):
        ...
        mock_conn.fetchval = AsyncMock(return_value=0)
        mock_conn.fetchrow = AsyncMock(return_value={
            "positive": 5, "neutral": 10, "negative": 2, "total": 17,
        })
    ...
    async def test_days_param_passed_to_queries(self, mock_conn):
        ...
        all_calls = mock_conn.fetch.call_args_list + mock_conn.fetchval.call_args_list + mock_conn.fetchrow.call_args_list
    ...
    async def test_org_id_passed_to_all_queries(self, mock_conn):
        ...
        all_calls = (mock_conn.fetch.call_args_list +
