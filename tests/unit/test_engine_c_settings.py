...
class TestEngineCSettingsExist:
    ...
    def test_identifier_extraction_enabled(self):
        ...
        assert settings.identifier_extraction_enabled is True, \
    ...
    def test_template_matching_enabled(self):
        ...
        assert settings.template_matching_enabled is True, \
            "Default should be True"
    ...
    def test_identifier_cluster_interval_s(self):
        ...
        assert settings.identifier_cluster_interval_s == 300, \
...
class TestEngineCComposeVars:
    ...
    def test_compose_has_engine_c_vars(self):
        ...
        assert "template_matching_enabled" in text, \
            "compose.yml missing TEMPLATE_MATCHING_ENABLED"
