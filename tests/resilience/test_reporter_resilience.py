...
class TestTemplateMatchingResilience:
    ...
    def test_no_keywords_no_crash(self):
        ...
        from anveshak.analyst.templates import ScamTemplate, match_templates
    ...
    def test_none_embedding_no_crash(self):
        ...
        template = ScamTemplate(
            ...
            display="Test",
            category="fraud",
            keywords=["fraud", "bank", "account"],
            min_keyword_hits=2,
            expected_identifiers=["PHONE_IN"],
            severity="CRITICAL",
            reference_embedding=None,
            legal_sections=["BNS 318"],
        )
        result = match_templates(
            content_keywords={"fraud", "bank", "account"},
...
class TestReportIdentifierDBFailure:
    ...
    async def test_identifier_db_error_does_not_crash_report(self):
        ...
        with (
            ...
            assert (
                mock_db.set_report_generated.await_count == 1
...
class TestBuildRecommendedActionsResilience:
    ...
    def test_mixed_known_unknown_templates(self):
        ...
        matches = [
            ...
            {
                "template_name": "alien_invasion",
                "template_display": "Aliens",
                "confidence": 0.5,
                "severity": "LOW",
                "legal_sections": None,
                "match_count": 1,
