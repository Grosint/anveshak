...
See: `.claude/skills/learned/stats-first-llm-second.md`
...
See: `.claude/skills/learned/data-driven-reports-over-llm.md`
...
See: `.claude/skills/learned/factual-sections-alongside-llm.md`
...
See: `.claude/skills/learned/template-driven-actions-not-llm.md`