...
| Recommended actions assume prosecution powers | output is mis-framed for a service that does not prosecute | recorded in [deferred_scope.md](deferred_scope.md); the Intelligence Bureau persona is the lens that catches it in review |
