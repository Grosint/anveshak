...
See: `.agents/skills/learned/references/entity-name-normalization.md`
...
See: `.agents/skills/learned/references/identifier-extraction-before-ml.md`
...
See: `.agents/skills/learned/references/spacy-entity-type-naming.md`
...
See: `.agents/skills/learned/references/scam-template-dual-matching.md`
...
See: `.agents/skills/learned/references/mule-account-cross-domain-indicator.md`

## New Identifier Type Wiring

Adding a new type requires updating 13 files across 4 layers. Missing any one → silent breakage.
See: `.agents/skills/learned/references/identifier-type-wiring-checklist.md`