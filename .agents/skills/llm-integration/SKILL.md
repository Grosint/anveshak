...
description: "LLM usage in reports and assessments. Covers stats-first LLM-second phasing, 90 percent SQL and 10 percent LLM report generation, factual DB sections appended alongside LLM output, and template-driven recommended actions. Use when working on report generation, LLM prompts, BLUF content, services/reporter, or Ollama calls."
---
...
See: `.agents/skills/learned/references/stats-first-llm-second.md`
...
See: `.agents/skills/learned/references/data-driven-reports-over-llm.md`
...
See: `.agents/skills/learned/references/factual-sections-alongside-llm.md`
...
See: `.agents/skills/learned/references/template-driven-actions-not-llm.md`