...
- After embedding, compute cosine similarity against topic query embedding
  ...
  See: `.agents/skills/learned/references/post-embedding-relevance-gate.md`
...
- Topic content queries must include BOTH `topic_id = $1` AND
  ...
  See: `.agents/skills/learned/references/cross-topic-join-table-queries.md`
...
- ARQ child jobs enqueued from parent job (not scheduler) with
  ...
  See: `.agents/skills/learned/references/causal-arq-job-chaining.md`
...
- Global threshold fails for mixed-breadth topics (IOR median 0.14 vs LAC 0.26)
  ...
  See: `.agents/skills/learned/references/per-topic-relevance-auto-calibration.md`
...
- In-memory URL set per scrape job skips duplicate media downloads
  ...
  See: `.agents/skills/learned/references/redis-url-dedup-sha256-ttl.md`, `.agents/skills/learned/references/url-level-media-dedup.md`
...
- Fetching full article from RSS: validate content BEFORE replacing summary
  ...
  See: `.agents/skills/learned/references/rss-fetch-paywall-validation.md`, `.agents/skills/learned/references/quality-ratio-bypass-on-length.md`
