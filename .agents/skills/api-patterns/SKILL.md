---
name: api-patterns
description: "FastAPI route and WebSocket patterns. Covers WebSocket auth by query-param token verified before accept, webhook fire-and-forget that never blocks primary delivery, and additive backfill through a join table. Use when writing API routes, WebSocket handlers, webhooks, or backfill logic."
---
...
See: `.agents/skills/learned/references/websocket-auth-pattern.md`
...
See: `.agents/skills/learned/references/additive-backfill-join-table.md`
