...
def upgrade() -> None:
    ...
    op.execute("""
        CREATE TABLE vision_results (
            ...
            yolo_detections         JSONB,        -- [{"label": "person", "confidence": 0.98, ...}]
            clip_labels             JSONB,        -- [{"label": "...", "score": 0.87}]
            deepfake_score          FLOAT,        -- 0.0–1.0 probability of deepfake
            deepfake_model          TEXT,         -- model used for deepfake detection
            synthetic_probability   FLOAT,        -- 0.0–1.0 AI-generated image probability
